...
class DgtTranslate(object):
    ...
    def text(self, text_id, msg=''):
        ...
        if text_id == 'B00_timemode_fixed_menu':
            entxt = Dgt.DISPLAY_TEXT(l='Move time', m='Move t', s=None, wait=False, beep=bl_button, maxtime=0)
        ...
        if text_id == 'B00_tc_fixed':
            ...
            detxt = Dgt.DISPLAY_TEXT(l='Zug      ' + msg, m='Zug' + msg, s='zug ' + msg, wait=False, beep=bl_button, maxtime=0)
        ...
        if text_id == 'B00_tc_blitz':
            ...
            detxt = Dgt.DISPLAY_TEXT(l='Spiel t  ' + msg, m='Spiel ' + msg, s='spl ' + msg, wait=False, beep=bl_button, maxtime=0)
